    ...
    return (
        <div className='home-collections'>
            <div className='home-collections-left'>
                ...
                <span style={{ marginTop: "30px" }}><span style={{ color: "#F0484B" }}>The Chocolate Monkeys are stored as ERC-721 tokens on the Ethereum blockchain and hosted on IPFS. (See Record and Proof.) To access owners only areas such as The Candy Shop, our owners will need to be signed into their Crypto Wallet such as Metamask or TrustWallet.</span><br /><br />
                ...
                <button style={{ marginTop: "30px" }} className='btn btn1'>CHECK "OWNER BENEFITS AND RIGHTS"</button>
            </div>
            <div className='home-collections-center'></div>
            <div className='home-collections-right'>
                <span>Price:</span>
                <span style={{ fontSize: "30px" }}>0.07 ETHER</span>
                <span>Blockchain:</span>
                <span style={{ fontSize: "30px" }}>ETHEREUM MAINNET</span>
                <button style={{ marginTop: "20px", marginBottom: "20px" }} className='btn btn2'>BUY NOW</button>
