    ...
    return (
        <div className='home-collections'>
            <div className='home-collections-left'>
                ...
                <span style={{ marginTop: "30px" }}><span style={{ color: "#F0484B", fontWeight: 'bold' }}>The Chocolate Monkeys are stored as ERC-721 tokens on the Ethereum blockchain and hosted on IPFS. (See Record and Proof.) To access owners only areas such as The Candy Shop, our owners will need to be signed into their Crypto Wallet such as Metamask or TrustWallet.</span><br /><br />
