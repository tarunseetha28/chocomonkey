    ...
    return (
        <>
            ...
            <div style={{ backgroundColor: "#F3454A" }} className='team'>
                <div className="team-left">
                    <span style={{ color: "white", fontSize: "120px", lineHeight: "100px", fontWeight: 'bold' }}>TEAM OF<br /> EXECUTIVES</span>
